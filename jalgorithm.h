...
namespace j_algorithm
{
	...
	namespace detail
	{
		...
		using execution_policy = std::conditional_t<parallel, std::execution::parallel_policy, std::execution::sequenced_policy>;
	...
	{
		return detail::partition_impl(first, last, pred, detail::iterator_category_t<ForwardIt> {});
	}
